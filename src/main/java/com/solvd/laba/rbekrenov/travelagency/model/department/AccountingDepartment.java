...
import com.solvd.laba.rbekrenov.travelagency.model.finance.payment.BankAccount;
...
public class AccountingDepartment extends Department implements BudgetManagement, BillManagement, SalaryManagement {
    ...
    public void paySalary(Employee e) {
        ...
        try {
            ...
            PaymentProcessor.processPayment(salary, companyBankAccount, e.getSalaryCredentials());
    ...
    public void payBill(Bill bill) {
        try {
            ...
            PaymentProcessor.processPayment(bill, companyBankAccount, bill.getReceiverCredentials());
        } catch (AlreadyPaidException ex){
            log.error(ex.getMessage());
        }
    }
