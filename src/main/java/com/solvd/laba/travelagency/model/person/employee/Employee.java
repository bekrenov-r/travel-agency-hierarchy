...
public abstract class Employee extends Person {
    private static final int YEARS_OF_SERVICE_NEEDED_FOR_SUPPLEMENT = 5;
    ...
    public double calculateSalary() {
        return getMonthSalary() + calculateBonus() + calculateServiceSupplement();
    }

    protected double calculateServiceSupplement(){
        ...
        if(yearsOfService >= YEARS_OF_SERVICE_NEEDED_FOR_SUPPLEMENT){
